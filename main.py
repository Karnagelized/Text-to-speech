...
def main():
    ...
    # Choose button
    clear_button = Button(path_frame,
                          background='white',
                          width=10,
                          text='Choose',
                          command=save_file,
    ...
    language_box = ttk.Combobox(language_frame,
                              font=('Times New Roman', 20),
                              values=languages,
